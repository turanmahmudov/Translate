...
UBUNTU_TRANSLATION_DOMAIN="translate.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/Translate/tests/autopilot/run
aptest.depends  = sub-Translate

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Translate/tests/unit
unittest.depends  = sub-Translate
